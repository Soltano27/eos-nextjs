(function(){
  ...
  window.submitContactForm=function(){
    ...
    var mailto='mailto:theeosanyafoundation@gmail.com?subject='+encodeURIComponent('[EOS Website] '+(s||'General Enquiry'))+'&body='+encodeURIComponent('Name: '+n+'\nEmail: '+e+'\n\n'+m);
  ...
  if(footer){
    // Update email link
    var emailLinks=footer.querySelectorAll('.footer-email,a[href*="info@theeosfoundation"]');
    emailLinks.forEach(function(a){
      a.href='mailto:theeosanyafoundation@gmail.com';
      a.textContent='theeosanyafoundation@gmail.com';
    });
    // Update address
    var addrSpans=footer.querySelectorAll('.address,.footer-brand p');
    addrSpans.forEach(function(el){
      if(el.textContent.includes('Lagos')||el.textContent.includes('Nigeria')){
        if(el.classList.contains('address')){el.textContent='5 Kola Iyaomolere Street, Ogudu Ori-Oke, Lagos';}
      }
    });
    // Update social links
    ...
    socialLinks.forEach(function(a){
      ...
      if(t==='Instagram')a.href='https://www.instagram.com/theeosfoundation?igsh=MTN4Y3hzbmVub3l1Mw==';
      if(t==='LinkedIn')a.href='https://www.linkedin.com/company/the-emmanuel-olatunde-sanya-foundation/';
      if(t==='YouTube')a.href='https://youtube.com/@theeosfoundation?si=0mYE2fzeZ-JrO_6J';
      if(t==='Twitter / X')a.href='#';
      if(t==='Substack')a.href='#';
      if(t.includes('@'))a.href='mailto:theeosanyafoundation@gmail.com';
      a.target='_blank';
    });
    // Update copyright year
    var copy=footer.querySelector('.footer-bottom p');
    if(copy)copy.textContent='© 2025 EOS Youth Brain Health Culture Organisation · Lagos, Nigeria';
  }

  // Update social CTAs section on homepage with real links
  document.querySelectorAll('.cta-card a').forEach(function(a){
    var t=a.textContent.trim();
    if(t.includes('YouTube'))a.href='https://youtube.com/@theeosfoundation?si=0mYE2fzeZ-JrO_6J';
    if(t.includes('Substack'))a.href='#';
    if(t.includes('Instagram'))a.href='https://www.instagram.com/theeosfoundation?igsh=MTN4Y3hzbmVub3l1Mw==';
    if(t.includes('LinkedIn'))a.href='https://www.linkedin.com/company/the-emmanuel-olatunde-sanya-foundation/';
    a.target='_blank';
  });
