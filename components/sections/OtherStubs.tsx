...
<div id="view-cortex" class="page-view">
  ...
  <div class="cortex-index-body">
    <!-- Featured -->
    <div class="ci-featured" data-route="cortex-article-1">
      <div class="ci-feat-img" style="background:linear-gradient(135deg,#0A3A6E,#0A84C8)">
        <span class="ci-feat-issue">ISSUE 001</span>
      </div>
      <div class="ci-feat-body">
        <span class="ci-feat-label">Featured Article</span>
        <div class="ci-feat-cat" style="color:#0A84C8">Physical Brain Health</div>
        <h2>Is Your Brain Healthy? What Brain Health Is and Why It Matters</h2>
        <p>The brain controls everything — your thoughts, decisions, emotions, and every function your body carries out. But how many of us actually know whether our brain is working well? This article breaks down what brain health really means, what damages it, and exactly what you can do about it.</p>
        <a class="read-more" data-route="cortex-article-1" style="margin-top:24px;font-size:14px">Read Full Article <span>→</span></a>
      </div>
    </div>
    <!-- Grid of all issues -->
...
<!-- ══════════════════════════════
     CORTEX ARTICLE 1 — IS YOUR BRAIN HEALTHY?
══════════════════════════════ -->
<div id="view-cortex-article-1" class="page-view">
  <div class="art-hero" style="background:linear-gradient(135deg,#0A3A6E 0%,#0A84C8 100%)">
    <div class="art-hero-inner">
      <div class="art-breadcrumb">
        ...
        <span style="opacity:0.9">Issue 001</span>
      </div>
      <div class="art-meta-row">
        <span class="art-issue-badge">ISSUE 001</span>
        <span class="art-cat-badge" style="background:rgba(10,132,200,0.25);color:#7DD3FC">Physical Brain Health</span>
      </div>
  ...
  <div class="art-layout">
    <aside class="art-sidebar">
      <div class="art-toc">
        ...
        <a class="art-toc-item" href="#s-what">What Is the Brain?</a>
        <a class="art-toc-item" href="#s-health">What Is Brain Health?</a>
        <a class="art-toc-item" href="#s-factors">Factors That Affect Brain Health</a>
        <a class="art-toc-item" href="#s-signs">Signs of Poor Brain Health</a>
        <a class="art-toc-item" href="#s-care">How to Take Care of Your Brain</a>
      ...
      <div class="art-key-takeaways">
        ...
        <ul class="art-kt-list">
          <li>The brain is the body's control centre — responsible for thinking, emotions, memory, and all bodily functions.</li>
          <li>Brain health is how well your brain functions across thinking, memory, emotions, and behaviour.</li>
          <li>Lifestyle factors like nutrition, sleep, exercise, stress, and substance use all shape brain health.</li>
          <li>Poor brain health shows through symptoms like memory loss, confusion, mood changes, and headaches.</li>
          <li>Protecting your brain requires healthy eating, regular exercise, quality sleep, stress management, and routine check-ups.</li>
        </ul>
      </div>
    </aside>
...
<!-- ══════════════════════════════
     CORTEX ARTICLE 2 — MIGRAINES
══════════════════════════════ -->
<div id="view-cortex-article-2" class="page-view">
  <div class="art-hero" style="background:linear-gradient(135deg,#3A1A70 0%,#5B3FA0 100%)">
    <div class="art-hero-inner">
      <div class="art-breadcrumb">
        <span data-route="cortex" style="cursor:pointer;opacity:0.6;transition:opacity 0.2s">The Cortex Printout</span>
        <span style="opacity:0.3;margin:0 8px">/</span>
        <span style="opacity:0.9">Issue 002</span>
      </div>
      <div class="art-meta-row">
        <span class="art-issue-badge">ISSUE 002</span>
        <span class="art-cat-badge" style="background:rgba(91,63,160,0.25);color:#C4B5FD">Physical Brain Health</span>
      </div>
  ...
  <div class="art-layout">
    <aside class="art-sidebar">
      <div class="art-toc">
        <div class="art-toc-title">In This Article</div>
        <a class="art-toc-item" href="#m-intro">Introduction</a>
        <a class="art-toc-item" href="#m-what">What Is a Migraine?</a>
        <a class="art-toc-item" href="#m-diff">Migraine vs Headache</a>
        <a class="art-toc-item" href="#m-stages">Stages of a Migraine</a>
        <a class="art-toc-item" href="#m-triggers">What Triggers Migraines?</a>
        <a class="art-toc-item" href="#m-types">Types of Migraines</a>
        <a class="art-toc-item" href="#m-cure">Are Migraines Curable?</a>
        <a class="art-toc-item" href="#m-doctor">When to See a Doctor</a>
        <a class="art-toc-item" href="#m-faq">FAQs</a>
      </div>
      <div class="art-key-takeaways">
        <div class="art-kt-title">Key Takeaways</div>
        <ul class="art-kt-list">
          <li>Migraines are neurological conditions, not just bad headaches. They can cause severe pain, nausea, and sensitivity to light and sound.</li>
          <li>Migraines often occur in four stages: prodrome, aura, headache, and postdrome — each with distinct symptoms.</li>
          <li>Poor sleep, stress, dehydration, skipping meals, alcohol, and bright lights can all trigger migraines.</li>
          <li>Migraines cannot always be permanently cured, but they can be managed through medication and lifestyle changes.</li>
          <li>Frequent or severe migraines should never be ignored. Early medical attention prevents complications.</li>
        </ul>
      </div>
    </aside>
    <article class="art-body">
...
<!-- ══════════════════════════════
     CORTEX ARTICLE 3 — SEIZURES & EPILEPSY
══════════════════════════════ -->
<div id="view-cortex-article-3" class="page-view">
  <div class="art-hero" style="background:linear-gradient(135deg,#006A58 0%,#00BFA5 100%)">
    <div class="art-hero-inner">
      <div class="art-breadcrumb">
        <span data-route="cortex" style="cursor:pointer;opacity:0.6;transition:opacity 0.2s">The Cortex Printout</span>
        <span style="opacity:0.3;margin:0 8px">/</span>
        <span style="opacity:0.9">Issue 003</span>
      </div>
      <div class="art-meta-row">
        <span class="art-issue-badge">ISSUE 003</span>
        <span class="art-cat-badge" style="background:rgba(0,191,165,0.2);color:#5EEAD4">Physical Brain Health</span>
      </div>
  ...
  <div class="art-layout">
    <aside class="art-sidebar">
      <div class="art-toc">
        <div class="art-toc-title">In This Article</div>
        <a class="art-toc-item" href="#e-intro">Introduction</a>
        <a class="art-toc-item" href="#e-seizure">What Is a Seizure?</a>
        <a class="art-toc-item" href="#e-epilepsy">What Is Epilepsy?</a>
        <a class="art-toc-item" href="#e-causes">Causes and Risk Factors</a>
        <a class="art-toc-item" href="#e-types">Types of Seizures</a>
        <a class="art-toc-item" href="#e-diagnosis">Diagnosis</a>
        <a class="art-toc-item" href="#e-treatment">Treatment</a>
        <a class="art-toc-item" href="#e-firstaid">Seizure First Aid</a>
        <a class="art-toc-item" href="#e-faq">FAQs</a>
      </div>
      <div class="art-key-takeaways">
        <div class="art-kt-title">Key Takeaways</div>
        <ul class="art-kt-list">
          <li>A seizure is a sudden burst of abnormal electrical activity in the brain. Epilepsy is the disorder characterised by recurrent, unprovoked seizures.</li>
          <li>Not all seizures involve convulsions. Not everyone who has a seizure has epilepsy.</li>
          <li>Causes include head injuries, infections, stroke, genetic factors, and developmental conditions.</li>
          <li>Epilepsy can often be effectively managed through medications, dietary changes, devices, or surgery.</li>
          <li>Knowing proper seizure first aid and challenging harmful myths can save lives and reduce stigma.</li>
        </ul>
      </div>
    </aside>
    <article class="art-body">
